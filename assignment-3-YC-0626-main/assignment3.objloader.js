...
if (material.hasTexture()) {
    // If the material has a texture, calculate tangents and merge attributes
    ...
    for (let i = 0; i < vertex_positions.length / 3; i++) {
        vertex_data.push(
            vertex_positions[i * 3], vertex_positions[i * 3 + 1], vertex_positions[i * 3 + 2], // Position
            vertex_normals[i * 3], vertex_normals[i * 3 + 1], vertex_normals[i * 3 + 2],       // Normal
            vertex_tangents[i * 3], vertex_tangents[i * 3 + 1], vertex_tangents[i * 3 + 2],   // Tangent
            vertex_texture_coords[i * 2], vertex_texture_coords[i * 2 + 1]                   // Texture Coordinate
        )
    }
} else {
    // Merge positions and normals only if no texture
    for (let i = 0; i < vertex_positions.length / 3; i++) {
        vertex_data.push(
            vertex_positions[i * 3], vertex_positions[i * 3 + 1], vertex_positions[i * 3 + 2], // Position
            vertex_normals[i * 3], vertex_normals[i * 3 + 1], vertex_normals[i * 3 + 2]       // Normal
